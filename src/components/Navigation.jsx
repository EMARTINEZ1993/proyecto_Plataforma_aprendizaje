...
export default function Navigation({ user, logout, onThemeChange, currentTheme }) {
    ...
    const toggleMute = () => {
        ...
        window.location.reload(); // Simple way to apply mute change globally for now
    };
                        ...
                        <div className="modal-body" style={{ background: 'var(--card-bg)', border: 'none', color: 'var(--text-primary)' }}>
                            ...
                            <div>
                                ...
                                >
                                    ...
                                    <option value="matrix" disabled={true}>Matrix Mode (Bloqueado 🔒)</option>
                                </select>
                            </div>
                        </div>
                    </div>
